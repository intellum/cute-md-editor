(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("showdown"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "showdown"], factory);
	else if(typeof exports === 'object')
		exports["cute-md-editor"] = factory(require("react"), require("showdown"));
	else
		root["cute-md-editor"] = factory(root["react"], root["showdown"]);
...
var _MarkdownEditor$defau, _MarkdownEditor$propT;
...
var _showdown = __webpack_require__(21);
...
var _svgDefinitions = __webpack_require__(10);
...
var MarkdownEditor = function (_Component) {
  ...
  function MarkdownEditor(props) {
    ...
    _this.state = {
      ...
      asMarkdodwn: _this.props.asMarkdown,
      content: _this.props.content
    };
    _this.converter = new _showdown.Converter();
  ...
  _createClass(MarkdownEditor, [{
    key: 'renderedHTML',
    value: function renderedHTML(content) {
      return {
    ...
    key: 'insertContent',
    value: function insertContent(contentLeft) {
      var _this2 = this;
      ...
      this.setState({
        ...
        if (selectedWord.length == 0) {
          _this2.refs.textArea.selectionEnd = cursorStart + contentLeft.length;
        } else {
          _this2.refs.textArea.selectionEnd = cursorEnd + contentLeft.length + contentRight.length;
        }
      });
    }
  }, {
    key: 'handleFileUpload',
    value: function handleFileUpload(path) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_toolbar2.default, {
          ...
          asHTML: asHTML }),
        asMarkdown && asHTML && _react2.default.createElement(
          'div',
          { className: 'react-md-preview-area' },
          this.converter.makeHtml(content)
        ),
        asMarkdown && !asHTML && _react2.default.createElement('div', {
          className: 'react-md-preview-area',
        ...
        _react2.default.createElement(
          _fileUpload2.default,
          {
            ...
            removeCallback: function removeCallback(path) {
              return _this3.props.onFileRemoved(path);
            },
            uploadComplete: function uploadComplete(files) {
              return _this3.handleFileUpload(files);
            } },
          _react2.default.createElement('textarea', {
            ...
            onChange: function onChange(event) {
              return _this3.setState({ content: event.target.value });
            },
            value: content })
        ),
        _react2.default.createElement('textarea', {
...
MarkdownEditor.defaultProps = (_MarkdownEditor$defau = {
  content: "",
  elementId: ""
}, _defineProperty(_MarkdownEditor$defau, 'elementId', ""), _defineProperty(_MarkdownEditor$defau, 'asMarkdown', false), _defineProperty(_MarkdownEditor$defau, 'asHTML', false), _MarkdownEditor$defau);

MarkdownEditor.propTypes = (_MarkdownEditor$propT = {
  content: _propTypes2.default.string,
  asMarkdown: _propTypes2.default.bool
}, _defineProperty(_MarkdownEditor$propT, 'asMarkdown', _propTypes2.default.bool), _defineProperty(_MarkdownEditor$propT, 'elementId', _propTypes2.default.string), _defineProperty(_MarkdownEditor$propT, 'elementName', _propTypes2.default.string), _defineProperty(_MarkdownEditor$propT, 'uploadCallback', _propTypes2.default.func), _defineProperty(_MarkdownEditor$propT, 'removeCallback', _propTypes2.default.func), _MarkdownEditor$propT);
...
var FileUpload = function (_Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function removeFile(path) {
      ...
      this.props.removeCallback(path).then(function (res) {
        if (res.status === 200) {
    ...
    key: "handleDrop",
    value: function handleDrop(e, callback, uploadComplete) {
      var _this3 = this;

      noneShallPass(e);
      var files = e.dataTransfer.files;
      resetDropZoneStyles(e);
      callback(files).then(function (res) {
        if (res.data) {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          uploadComplete = _props.uploadComplete;

      var uploadedFiles = this.state.uploadedFiles.map(function (f, i) {
        return _react2.default.createElement(
          "li",
          { key: i },
          f,
        ...
        _react2.default.createElement(
          "div",
          {
            ...
            onDrop: function onDrop(e) {
              return _this4.handleDrop(e, callback, uploadComplete);
            } },
          children
        ),
        _react2.default.createElement(
          "div",
          { className: "dropzone-info", style: { display: hidden ? "none" : "inherit" } },
          _react2.default.createElement(
            "span",
            null,
            "Add files by dragging and dropping into the editor."
          ),
          this.state.uploadedFiles.length ? _react2.default.createElement(
            "ul",
            null,
            uploadedFiles
          ) : null
...
var Toolbar = function Toolbar(_ref) {
  ...
  var buttons = toolbarButtons.map(function (obj, i) {
    return _react2.default.createElement(
      'button',
      {
        type: 'button',
      ...
      _react2.default.createElement(
        'svg',
        { className: 'icon icon-' + obj.icon },
        _react2.default.createElement('use', { xlinkHref: '#icon-' + obj.icon })
      )
    );
  });
